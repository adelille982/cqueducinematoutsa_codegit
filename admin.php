  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="category_id" name="category_id">
        <option value="">CATÉGORIE DE TARIF</option>
        <?php $categoryTarifs = updateCategoty(); ?>
        <?php foreach ($categoryTarifs as $categoryTarif) : ?>
          <option value="<?= $categoryTarif['ID'] ?>"><?= $categoryTarif['category_name'] ?></option>
        <?php endforeach; ?>
      </select>
    </div>
